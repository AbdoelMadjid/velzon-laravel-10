                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <?php switch(Session::get('lang')):
                            case ('id'): ?>
                                <img src="<?php echo e(URL::asset('build/images/flags/id.svg')); ?>" class="rounded"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="<?php echo e(url('index/id')); ?>" class="dropdown-item notify-item language py-2"
                            data-lang="id" title="Indonesian">
                            <img src="<?php echo e(URL::asset('build/images/flags/id.svg')); ?>" alt="user-image"
...
<?php /**PATH D:\laragon\www3\velzon-default-10\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>