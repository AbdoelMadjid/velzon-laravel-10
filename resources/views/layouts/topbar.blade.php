                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        @switch(Session::get('lang'))
                            @case('id')
                                <img src="{{ URL::asset('build/images/flags/id.svg') }}" class="rounded"
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="{{ url('index/id') }}" class="dropdown-item notify-item language py-2"
                            data-lang="id" title="Indonesian">
                            <img src="{{ URL::asset('build/images/flags/id.svg') }}" alt="user-image"
